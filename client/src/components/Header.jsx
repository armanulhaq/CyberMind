...
const Navbar = () => {
    return (
        <nav className="max-w-5xl mx-auto my-5 flex items-center justify-between px-8 py-4 border border-[#FCFCFC] shadow-[0_0_20px_rgba(127,127,127,0.15)]  bg-white rounded-full">
